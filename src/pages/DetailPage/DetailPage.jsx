...
const articles = [
    ...
    examples: [
      {
        ...
        image: "https://dautu.vndirect.com.vn/wp-content/uploads/2021/12/can-1024x444.png",
      },
      {
        text: "Quy luật di truyền Menđen (chỉ trong lĩnh vực sinh học).",
        image: "https://viethungpham.com/wp-content/uploads/2015/08/mendel-refuted-darwinism-1.jpg?w=600",
      },
      {
        text: "Quy luật phản ứng hóa học (chỉ trong hóa học, không áp dụng sang vật lý xã hội).",
        image: "https://toplist.vn/images/800px/sach-on-thi-hoa-hoc-cho-ky-thi-thpt-quoc-gia-ban-phai-co-794872.jpg",
      },
    ],
  },
  {
    ...
    concept: "Là những quy luật tồn tại trong một số lĩnh vực của tự nhiên, xã hội và tư duy, có phạm vi rộng hơn quy luật riêng, nhưng chưa bao trùm tất cả.",
    examples: [
      {
  ...
  },
  {
    ...
    concept: "Là những quy luật của phép biện chứng duy vật, phản ánh các mối liên hệ phổ biến nhất của tất cả các sự vật, hiện tượng trong thế giới hiện thực.",
    examples: [
      {
        text: "Chưa có ( DEMO )",
        image:
          "https://cdn2.fptshop.com.vn/unsafe/triet_hoc_la_gi_7_7384fe684f.jpg",
      },
    ],
  },
];
  ...
  <>
    <div className="container py-5 mt-5 fade-in">
      ...
      >
        ...
        <p className="lead">{article.concept}</p>
      </div>
